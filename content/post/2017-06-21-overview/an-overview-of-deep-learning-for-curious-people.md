...
author: Jarvis Ma
date: 2017-06-21T12:06:59+08:00
draft: false
tags:
  - foundation
  - tutorial
...
![A Three-Layer Artificial Neural Network](/post/2017-06-21-overview/ANN.png)

*Fig. 1: A three-layer artificial neural network. Image source: [cs231n.github.io](http://cs231n.github.io/convolutional-networks/#conv).*
...
![The Data Scale Versus the Model Performance](/post/2017-06-21-overview/data_size_vs_model_performance.png)
...
![Illustration of the Human Visual Cortex System](/post/2017-06-21-overview/visual_cortex_system.png)
...
![The LeNet Architecture](/post/2017-06-21-overview/lenet.png)
...
![The Structure of an LSTM Cell](/post/2017-06-21-overview/LSTM.png)

*Fig. 6: The structure of an LSTM cell. Image source: [http://colah.github.io/posts/2015-08-Understanding-LSTMs](http://colah.github.io/posts/2015-08-Understanding-LSTMs).*
...
![A Character-Based Recurrent Neural Network Model Writes Like Shakespeare](/post/2017-06-21-overview/rnn_shakespeare.png)

*Fig. 7: A character-based recurrent neural network model writes like Shakespeare. Image source: [http://karpathy.github.io/2015/05/21/rnn-effectiveness](http://karpathy.github.io/2015/05/21/rnn-effectiveness).*
...
![A Sequence-to-Sequence Model for Generating Gmail Auto Replies](/post/2017-06-21-overview/seq2seq_gmail.png)

*Fig. 8: A sequence-to-sequence model for generating Gmail auto replies. Image source: [Google Blog](https://research.googleblog.com/2015/11/computer-respond-to-this-email.html).*
...
![An Autoencoder Model with a Bottleneck Layer](/post/2017-06-21-overview/autoencoder.png)
...
![PCA vs Autoencoder Outputs](/post/2017-06-21-overview/autoencoder_experiment.png)
...
![AlphaGo Neural Network Training Pipeline and Architecture](/post/2017-06-21-overview/alphago_paper.png)
...
![The Architecture of a Generative Adversarial Network](/post/2017-06-21-overview/GAN.png)
...
![Deep Learning Toolkits](/post/2017-06-21-overview/deep_learning_toolkits.png)
